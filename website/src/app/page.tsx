...
export default function Home() {
  return (
    <>
      ...
      <MaxWidthWrapper className='mx-auto mb-4 pt-16 sm:mt-40 flex flex-col items-center justify-center text-center'>
          <div className='mx-auto pt-4 mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50'>
      ...
      <div>
        <div className="relative isolate">
          ...
          className="pointer-events-none absolute inset-x-0 top-40 -z-10 transform-gpu overflow-hidden sm:-top-96 blur-3xl">
            <div
              style={{
                clipPath:
