...
@pytest.mark.asyncio
async def test_handle_help(mock_update, mock_context, user):
    mock_update.message.text = "/help"
    await gm.handle_help(mock_update, mock_context)
...
@pytest.mark.asyncio
async def test_handle_add_address(mock_update, mock_context, dbclient, user, address_string_correct):
    # prepare test
...
@pytest.mark.asyncio
async def test_handle_add_address_fails_bc_too_short(mock_update, mock_context, dbclient, user, address_string_too_short):
    # prepare test
...
@pytest.mark.asyncio
async def test_handle_delete_address(mock_update, mock_context, dbclient, user, address):
    # prepare call
...
@pytest.mark.asyncio
async def test_handle_send_fails_no_addressee_referenced(mock_update, mock_context, user):
    # prepare mock objects
...
@pytest.mark.asyncio
async def test_handle_send_fails_no_previous_draft(mock_update, mock_context, user, address):
    # prepare mock objects
